...
public class FXMLReservaRoundTripController implements Initializable {
    ...
    @FXML private Label lFromC1; //Ciudades de partida
    @FXML private Label lFromC2;
    @FXML private Label lToC1; //Ciudades de llegada
    @FXML private Label lToC2;
    @FXML private Label lFliNum1; //Numeros de vuelo
    @FXML private Label lFliNum2;
    @FXML private Label lDepDate1; //Fechas de Salida
    @FXML private Label lDepDate2;
    @FXML private Label lDepTime1; //Horas de salida
